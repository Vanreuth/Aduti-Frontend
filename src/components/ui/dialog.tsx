...
function DialogContent({
  ...
  const sizeClass =
    size === "full"
      ? "w-[98vw] max-w-[98vw] sm:w-[96vw] sm:max-w-[96vw] max-h-[94vh]"
      : size === "2xl"
        ? "w-[98vw] sm:w-[96vw] lg:w-[92vw] xl:w-[88vw] max-w-[1550px] max-h-[94vh]"
        : size === "xl"
          ? "w-[98vw] sm:w-[96vw] lg:w-[92vw] xl:w-[88vw] max-w-[1400px] max-h-[92vh]"
          : size === "lg"
            ? "w-[96vw] sm:w-[92vw] max-w-[1100px] max-h-[90vh]"
